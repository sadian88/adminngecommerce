...
class DeleteUserComponent {
    ...
    delete() {
        this.userService.deleteUser(this.user_selected._id).subscribe((resp) => {
            console.log(resp);
            this.UserD.emit("");
            this.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], { text: `success-'EL USUARIO SE ELIMINO CORRECTAMENTE.'` });
            this.modal.close();
        }, (error) => {
            if (error.error) {
...
class EditUsersComponent {
    ...
    save() {
        ...
        this.userService.updateUser(data).subscribe((resp) => {
            ...
            this.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], { text: `success-'EL USUARIO SE ACTUALIZO CORRECTAMENTE.'` });
            this.modal.close();
        }, (error) => {
            if (error.error) {
                this.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], { text: `danger-'${error.error.message}'` });
...
EditUsersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EditUsersComponent, selectors: [["app-edit-users"]], inputs: { user_selected: "user_selected" }, outputs: { UserE: "UserE" }, decls: 53, vars: 6, consts: [[1, "modal-content"], [1, "modal-header"], ["id", "example-modal-sizes-title-lg", 1, "modal-title", "h4"], [1, "icon-2x", "text-dark-50", "flaticon-user-add", "mx-2"], [1, "overlay", "overlay-block", "cursor-default", "modal-body"], [1, "row"], [1, "col-6"], [1, "form-group"], [1, "text-danger"], ["type", "text", "placeholder", "", "name", "name", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "form-text", "text-muted"], ["type", "text", "placeholder", "", "name", "surname", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "col-12"], ["type", "email", "placeholder", "", "name", "email", 1, "form-control", 3, "ngModel", "ngModelChange"], ["for", ""], ["type", "password", "id", "", "placeholder", "******", "name", "password", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "password", "id", "", "placeholder", "******", "name", "repet_password", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-primary", "btn-elevate", "mr-2", 3, "click"], ["type", "button", 1, "btn", "btn-light", "btn-elevate", "mr-2", 3, "click"]], template: function EditUsersComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](28, "Direcci\u00F3n de correo: ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditUsersComponent_Template_input_ngModelChange_47_listener($event) { return ctx.repet_password = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
class UsersService {
    ...
    allUsers(search) {
        ...
        let URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/users/list?search=" + search;
    ...
    createUser(data) {
        this.isLoadingSubject.next(true);
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]({ 'token': this.authservice.token });
        let URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/users/register_admin";
    ...
    updateUser(data) {
        this.isLoadingSubject.next(true);
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]({ 'token': this.authservice.token });
        let URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/users/update";
    ...
    deleteUser(user_id) {
        this.isLoadingSubject.next(true);
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]({ 'token': this.authservice.token });
        let URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/users/delete?_id=" + user_id;
...
class AddUsersComponent {
    ...
    save() {
        ...
        if (this.password != this.repet_password) {
            this.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], { text: `danger-'Upps! Necesita ingresar contraseñas iguales.'` });
            return;
        }
        let data = {
            name: this.name,
        ...
        this.userService.createUser(data).subscribe((resp) => {
            ...
            this.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], { text: `success-'EL USUARIO SE REGISTRO CORRECTAMENTE.'` });
            this.modal.close();
        }, (error) => {
            if (error.error) {
                this.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], { text: `danger-'${error.error.message}'` });
...
AddUsersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AddUsersComponent, selectors: [["app-add-users"]], outputs: { UserC: "UserC" }, decls: 53, vars: 5, consts: [[1, "modal-content"], [1, "modal-header"], ["id", "example-modal-sizes-title-lg", 1, "modal-title", "h4"], [1, "icon-2x", "text-dark-50", "flaticon-user-add", "mx-2"], [1, "overlay", "overlay-block", "cursor-default", "modal-body"], [1, "row"], [1, "col-6"], [1, "form-group"], [1, "text-danger"], ["type", "text", "placeholder", "", "name", "name", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "form-text", "text-muted"], ["type", "text", "placeholder", "", "name", "surname", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "col-12"], ["type", "email", "placeholder", "", "name", "email", 1, "form-control", 3, "ngModel", "ngModelChange"], ["for", ""], ["type", "password", "id", "", "placeholder", "******", "name", "password", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "password", "id", "", "placeholder", "******", "name", "repet_password", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-primary", "btn-elevate", "mr-2", 3, "click"], ["type", "button", 1, "btn", "btn-light", "btn-elevate", "mr-2", 3, "click"]], template: function AddUsersComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](47, "input", 16);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddUsersComponent_Template_input_ngModelChange_47_listener($event) { return ctx.repet_password = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/* harmony import */ var _components_delete_user_delete_user_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/delete-user/delete-user.component */ "5XKR");
/* harmony import */ var _components_edit_users_edit_users_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/edit-users/edit-users.component */ "CfIK");
...
class UsersListComponent {
    ...
    editUser(user) {
        const modalRef = this.modalService.open(_components_edit_users_edit_users_component__WEBPACK_IMPORTED_MODULE_3__["EditUsersComponent"], { centered: true, size: 'md' });
    ...
    delete(user) {
        const modalRef = this.modalService.open(_components_delete_user_delete_user_component__WEBPACK_IMPORTED_MODULE_2__["DeleteUserComponent"], { centered: true, size: 'md' });
        modalRef.componentInstance.user_selected = user;
        modalRef.result.then(() => {
        }, () => {
        });
